...
export default function BillingItemsTable({ items, onRemove, onUpdateDiscount }) {
  if (items.length === 0) {
    return (
      <div className="flex-center" style={{ height: 300, border: '2px dashed rgba(255,255,255,0.2)', borderRadius: 'var(--radius-lg)', color: '#a3b8aa' }}>
  ...
  return (
    <div style={{ background: 'rgba(0,0,0,0.2)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 'var(--radius-md)', overflowX: 'auto' }}>
