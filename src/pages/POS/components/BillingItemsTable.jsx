...
export default function BillingItemsTable({ items, onRemove, onUpdateDiscount }) {
  if (items.length === 0) {
    return (
      <div className="flex-center" style={{ height: 300, border: '2px dashed var(--color-border)', borderRadius: 'var(--radius-lg)', color: 'var(--color-text-tertiary)' }}>
  ...
  return (
    <div style={{ background: 'var(--color-canvas)', border: '1px solid var(--color-border)', borderRadius: 'var(--radius-md)', overflowX: 'auto' }}>
